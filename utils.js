...
$('table#ticket_list tr').each(function() {
    if(ticket_row > 0) {
      ...
      if(ticket_subject.search(/HTTP Availability/) > 0) {
        ...
        display_tickets[display_tickets.length] = {"number": ticket_number, "subject": ticket_subject, "engineer": engineer, "status": ticket_status, "engineer_status": engineer_status, "URL": "https://noctane.contegix.com/noc/tickets/"+ticket_number, "ticket_container": ticket_subject_container, "ticket_row": this};
      }
    }
    ticket_row += 1;
});
